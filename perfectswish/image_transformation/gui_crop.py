...
#
#         self.canvas = tk.Canvas(self.root, width=max_width, height=max_height)
#         self.canvas.pack(side=tk.LEFT, padx=10, pady=10)
#
...
#
#         # Create a button for saving the image
#         self.save_image_button = tk.Button(self.root, text="Save Image", command=self.save_black_bg)
